    ...
    <section className="mx-auto max-w-sm px-4 py-10">
      ...
      <form onSubmit={onSubmit} className="mt-6 space-y-4">
        ...
        <div>
          ...
          <input value={form.password} onChange={e=>setForm({...form,password:e.target.value})} type="password" className="mt-1 w-full rounded-md border border-neutral-300 bg-white px-3 py-2 text-sm outline-none dark:border-neutral-700 dark:bg-neutral-900" />
        </div>
